...
export default class ChoicesDropdown {
   ...
   * */
  addValue (value, key) {
    // Remove item from the options list
    ...
    this.nodes.searchNode.value = value
  }
  ...
  * */
  ...
  resizeEditor (selectedCellNode) {
    const cellHeight = selectedCellNode.offsetHeight
    this.nodes.valuesNode.style.height = `${cellHeight}px`
  }
