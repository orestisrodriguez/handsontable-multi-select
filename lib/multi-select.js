...
export class MultiSelectEditor extends TextEditor {
  ...
  createElements () {
    ...
    this.choices.renderStructure({
      onInputChange: debounceFn(this.onInputChange.bind(this), { wait: DEBOUNCE_TIME }),
    })
  ...
  open () {
    ...
    }, this.lastCellInfo, { searchTerm: '', initial: true })
  ...
  onInputChange (value) {
    this.choices.setOptions(this.selectOptions.options, {
      key: this.valueKey, value: this.labelKey,
    }, this.lastCellInfo, { searchTerm: value, initial: false })
  }
}
