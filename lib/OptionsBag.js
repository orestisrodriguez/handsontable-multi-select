...
const ACTIVE_CLASS_NAMES = {
  ...
  valuesInput: "multi-select__editor-input",
...
export default class OptionsBag {
  ...
  renderStructure() {
    ...
    addClass(inputNode, ACTIVE_CLASS_NAMES.valuesInput)
  ...
  reset() {
    ...
    this.nodes.inputNode.innerHTML = ""
  }
   ...
   * */
  setValues = (values) => {
    Handsontable.dom.empty(this.nodes.inputNode)
